...
<div class="max-w-7xl mx-auto p-4">
    ...
    <!-- Export Buttons -->
    <div class="mb-4 text-left space-x-2">
        <button onclick="window.print()" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-gray-700">
            Print
        </button>
        <button onclick="exportToCSV()" class="bg-teal-600 text-white px-4 py-2 rounded hover:bg-green-700">
            Export CSV
        </button>
        <button onclick="exportToPDF()" class="bg-yellow-600 text-white px-4 py-2 rounded hover:bg-red-700">
            Export PDF
        </button>
    </div>
